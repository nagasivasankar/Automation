 ...
 */
public class ShiftSwapSucessActivity extends Legion_BaseActivity implements Legion_NetworkCallback {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.swap_request_sucess_activity);
    ...
    public void onBackPressed() {
        Intent i = new Intent(ShiftSwapSucessActivity.this, ScheduleShiftDetailsActivity.class);
