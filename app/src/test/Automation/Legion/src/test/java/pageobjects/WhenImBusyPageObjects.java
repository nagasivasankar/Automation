...
public class WhenImBusyPageObjects extends BaseClass {
	...
	public static final String TIMEBLOCKHRS = "//android.widget.TextView[@text='2pm - 6pm']";
	...
	//create variable of GETTINGTXT as static final string type
	...
	//constructor
	public WhenImBusyPageObjects(AppiumDriver driver)
	{
		this.d=driver;
	}

	//method for when im busy
	public String whenIBusy(AppiumDriver d)
	{
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.id(LNKAVAILABLITY)));
		d.findElementById(LNKAVAILABLITY).click();
		d.findElementById(BTNGOTIT).click();
		d.findElementById(BTNWHENIBUSY).click();
		String screensht=Utilities.captureScreenshot(d, "Busy");
		return screensht;
	}
